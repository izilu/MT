...
class ThorAgent:
    ...
    def __init__(
        ...
        #nav_graph
        self.nav_graph = None
        self.nav_graph_all = None
        self.obstacle_graph = None
        self.start_coord = None
        self.coord_memory = None
        self.out_save = None
    ...
    def _increment_episode_length(self):
        ...
        if self.nav_graph.sum() != 0:  #表示看到物体了
            if self.nav_len == 0: #说明刚开始进入到navigate to 阶段
                self.search_nav_sate = self.episode.environment.controller.state
            self.nav_len += 1
    ...
    def action(self, model_options, training, test_update):
        ...
        # self.episode.state_memory.append(self.environment.controller.state)  #将路径的绝对坐标存下来
        ...
        self.nav_graph_all = out.nav_graph_all
        self.obstacle_graph = out.obstacle_graph
        self.start_coord = out.start_coord
        self.coord_memory = out.coord_memory
        self.out_save = out.out_save
